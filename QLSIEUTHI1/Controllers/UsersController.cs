...
namespace QLSIEUTHI1.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(QLSIEUTHI1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'QLSIEUTHI1Context.User'  is null.");
        }
        ...
        //from bắt thông tin chúng ta vừa up lên
        [HttpPost]
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'QLSIEUTHI1Context.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
